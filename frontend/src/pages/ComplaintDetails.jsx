                    ...
                    >
                        ...
                        {complaint.attachmentUrl && (
                            <div style={{ marginBottom: '2.5rem' }}>
                                ...
                                <a href={`http://localhost:5000${complaint.attachmentUrl}`} target="_blank" rel="noopener noreferrer" style={{ display: 'block', borderRadius: '0.75rem', overflow: 'hidden', border: '1px solid var(--glass-border)', transition: 'transform 0.2s ease, box-shadow 0.2s ease', cursor: 'pointer' }}
                                        ...
                                        <div>
                                            {complaint.resolutionImageUrl && (
                                                <div style={{ marginBottom: '2rem' }}>
                                                    ...
                                                    <a href={`http://localhost:5000${complaint.resolutionImageUrl}`} target="_blank" rel="noopener noreferrer" style={{ display: 'block', borderRadius: '0.75rem', overflow: 'hidden', border: '1px solid var(--glass-border)', transition: 'transform 0.2s ease, box-shadow 0.2s ease', cursor: 'pointer' }}>
                                                        <img
                                                            src={`http://localhost:5000${complaint.resolutionImageUrl}`}
